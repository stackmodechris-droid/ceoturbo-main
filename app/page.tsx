...
export const metadata = buildMetadata({
  title: "ElectronicReboot | Fast, Reliable Device Repair",
  description: "Fast phone, tablet, laptop, desktop, and PC repair. Honest diagnostics, clear pricing, and a 90-day labor warranty on every repair.",
  path: "/",
  image: "/brand/electronicreboot-og.jpg",
  imageAlt: "ElectronicReboot — Tech Repair & Digital Growth",
});

const homeFaqs = [
  { question: "What services does ElectronicReboot provide?", answer: "We repair iPhones, Android phones, iPads, tablets, laptops, desktops, and Windows PCs. We also build high-converting websites and manage Meta ads." },
  ...
  { question: "Do you charge for a diagnostic?", answer: "Yes, $39–$49 depending on the device. The diagnostic fee is credited toward any approved repair, so you don't pay it twice." },
];
    ...
    <>
      <section className="hero section-dark">
        <div className="section-shell hero-grid">
          <div className="hero-copy">
            ...
            <p className="lede">ElectronicReboot repairs phones, tablets, laptops, desktops, and Windows PCs. We also provide high-converting websites and Meta ads virtual assistance. Serving Atlanta, Stone Mountain & surrounding cities (25-mile radius) — expanding to Florida soon.</p>
            ...
            <p className="hero-note">Flat diagnostic fee · credited toward your repair · 90-day labor warranty</p>
          </div>
      ...
      <section className="section section-dark">
        <div className="section-shell split-layout">
          <div><p className="eyebrow">No form. No data capture.</p><h2>Not sure which repair you need?</h2><p className="lede">Answer five quick questions and get a recommended starting point in your browser — nothing is saved.</p></div>
          <Qualifier />
        </div>
      </section>
      ...
      <section className="final-cta section-dark"><div className="section-shell"><h2>Ready to get your device repaired?</h2><p>Call us, book a drop-off, or come in anytime during business hours. No appointment needed for most repairs.</p><PrimaryLink href={SITE.phoneHref}>Call {SITE.phoneDisplay}</PrimaryLink></div></section>
    </>
  );
}
